...
- **Topic Focus**: `scanf("%s")` Whitespace Trap, `fgets()`, `strlen()` vs `sizeof()`, Array Non-reassignment, Character Pointer Reassignment, Manual `'\0'` Truncation, Password Salting, `strcmp()` Equality
