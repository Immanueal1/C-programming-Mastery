...
- **Topic Focus**: `fgets()` Truncation, `strcmp()` Lexicographical Sorting, `char *` vs `char []` Memory Segments, Buffer Overflow, Password Salting, Missing `'\0'` Ghost Memory, `fgets()` Newline Anomaly
