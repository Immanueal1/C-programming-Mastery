# 🔴 Chapter 3: Hard Practice Problems

> Advanced C programming challenges focusing on progressive tariff slabs, state machine validation, hardware component tolerances, nested ternary expressions, triage logic flags, spatial line overlaps, and date verification.
...
| [`23_etc_component_tolerance_band.c`](./23_etc_component_tolerance_band.c) | E&TC Component Tolerance Band | Range Mapping |
| [`24_anime_binge_decider.c`](./24_anime_binge_decider.c) | Anime Binge Decider | Arithmetic & Logic Synthesis |
| [`25_the_ultimate_ternary_puzzle.c`](./25_the_ultimate_ternary_puzzle.c) | The Ultimate Ternary Puzzle | Nested Ternary Operators (`? :`) |
| [`26_hospital_triage_system.c`](./26_hospital_triage_system.c) | Hospital Triage System | Priority Logic Flags |
| [`27_income_tax_calculator.c`](./27_income_tax_calculator.c) | Income Tax Calculator | Tiered Mathematical Logic |
| [`28_embedded_system_state_machine.c`](./28_embedded_system_state_machine.c) | Embedded System State Machine | `switch` inside `if` |
| [`29_intersecting_rectangles.c`](./29_intersecting_rectangles.c) | Intersecting Rectangles | Spatial Line Overlap Logic |
| [`30_date_validity_checker.c`](./30_date_validity_checker.c) | Date Validity Checker | Nested Date Validation Logic |
