...
<p align="center">
  <img src="assets/me_coding.gif" alt="C Programming Mastery Banner" width="100%" max-width="800px" style="border-radius: 10px; box-shadow: 0 4px 20px rgba(0,0,0,0.15);" />
</p>
...
<p align="center">
  <a href="#-learning-roadmap"><img src="https://img.shields.io/badge/Language-C11%20%2F%20C99-00599C?style=for-the-badge&logo=c&logoColor=white" alt="Language C" /></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-Dual%20MIT%20%2F%20CC%20BY--NC--ND%204.0-blue.svg?style=for-the-badge" alt="License Dual" /></a>
  <a href="ROADMAP.md"><img src="https://img.shields.io/badge/Status-Active%20Development-orange?style=for-the-badge" alt="Status" /></a>
  ...
  <a href="#-about-this-repository"><img src="https://img.shields.io/badge/Quality-Portfolio%20Grade-purple?style=for-the-badge" alt="Portfolio Quality" /></a>
</p>
...
```mermaid
flowchart TD
    A[01. Basics & Variables] --> B[02. Instructions & Operators]
    B --> C[03. Conditional Statements]
    C --> D[04. Loops & Control Flow]
    D --> E[05. Functions & Recursion]
    E --> F[06. Pointers & Memory Addresses]
    F --> G[07. Arrays & Multi-Dimensional Arrays]
    G --> H[08. Strings & Character Buffers]
    H --> I[09. Structures & Unions]
    I --> J[10. File I/O & Streams]
    J --> K[11. Dynamic Memory Allocation]
    K --> L[12. Practical Projects]
    L --> M[13. Data Structures & Algorithms]
    M --> N[14. Technical Interview Prep]

    style A fill:#1f2937,stroke:#3b82f6,stroke-width:2px,color:#fff
    style F fill:#1f2937,stroke:#8b5cf6,stroke-width:2px,color:#fff
    style K fill:#1f2937,stroke:#ec4899,stroke-width:2px,color:#fff
    style N fill:#1f2937,stroke:#10b981,stroke-width:2px,color:#fff
```
