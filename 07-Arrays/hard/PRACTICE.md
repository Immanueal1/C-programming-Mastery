...
- **Topic Focus**: Row-Major Memory Formulas, `arr` vs `&arr` Pointer Scaling, In-Place Rotations & Transposes, 2D Flattening via 1D Pointers, Macros, Off-By-One Bounds Tracing, Sub-Array Extraction, Matrix Symmetry
