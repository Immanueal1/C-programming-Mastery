# 🔴 Chapter 5: Hard Practice Problems

> Advanced C programming challenges focusing on multi-return exit paths, LIFO stack frame call order tracing, double-call Fibonacci recursion, digit sum decomposition, recursive exponentiation, post-call stack unwinding (Head Recursion), mutual recursion, variable shadowing scope boundaries, decimal-to-binary stack unwinding, and Collatz hailstone sequences.

---

## 📌 Short Description

This directory contains 10 advanced practice problems designed to test low-level call stack execution dynamics, multi-path conditional exits, tree-branching dual recursion, stack unwinding output ordering, mutual function interdependence, parameter shadowing, and multi-branch hailstone series.

---

## 📚 Topics Covered

- [x] Multi-Return Exit Paths & Immediate Function Termination
- [x] Deep Nested Function Call Execution Flow (LIFO Stack Frames)
- [x] Dual Recursive Calls ($N$-th Fibonacci Number: `fib(n-1) + fib(n-2)`)
- [x] Recursive Integer Digit Sum Decomposition (`n % 10` + `sumDigits(n / 10)`)
- [x] Recursive Exponentiation ($\text{base}^{\text{exp}}$)
- [x] Pre-Call vs. Post-Call Recursion (Head Recursion & Stack Unwinding)
- [x] Mutual Recursion (`isEven` ↔ `isOdd`)
- [x] Block Scope Variable Shadowing & Pass-by-Value Isolation
- [x] Decimal to Binary Conversion via Stack Unwinding
- [x] Multi-Branch Conditional Recursive Sequences (Collatz Hailstone Conjecture)
...
| :--- | :--- | :--- |
| [`21_multi_return_path_trap.c`](./21_multi_return_path_trap.c) | Multi-Return Path Trap | Return Values, Conditional Execution |
| [`22_deep_execution_tracer.c`](./22_deep_execution_tracer.c) | Deep Execution Tracer | Nested Calling, Execution Flow |
| [`23_nth_fibonacci_number.c`](./23_nth_fibonacci_number.c) | N-th Fibonacci Number | Multiple Recursive Calls |
| [`24_sum_of_digits_recursively.c`](./24_sum_of_digits_recursively.c) | Sum of Digits Recursively | Recursive Mathematical Logic |
| [`25_power_function_via_recursion.c`](./25_power_function_via_recursion.c) | Power Function via Recursion | Recursive Multiplication |
| [`26_pre_call_vs_post_call_recursion.c`](./26_pre_call_vs_post_call_recursion.c) | Pre-Call vs Post-Call Recursion | Stack Winding and Unwinding |
| [`27_recursive_even_odd_check.c`](./27_recursive_even_odd_check.c) | Recursive Even/Odd Check | Mutual Recursion (Conceptual) |
| [`28_shadowing_and_pass_by_value.c`](./28_shadowing_and_pass_by_value.c) | Shadowing and Pass-by-Value | Parameter Scope |
| [`29_decimal_to_binary_recursively.c`](./29_decimal_to_binary_recursively.c) | Decimal to Binary recursively | Recursive Modulo |
| [`30_the_collatz_conjecture.c`](./30_the_collatz_conjecture.c) | The Collatz Conjecture (Hailstone Sequence) | Conditional Recursive Steps |
