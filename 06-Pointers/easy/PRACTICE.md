# 🟢 Chapter 6 Easy Practice Workbook

> Practice workbook containing 10 beginner-level problems focused on pointer declarations, address-of (`&`) extraction, dereferencing (`*`), pointer address formatting (`%p`), call by value vs. call by reference fundamentals, character pointers, and basic pointer mutation.
...
- **Topic Focus**: Pointer Declaration, Address Extraction, Dereferencing, %p Specifier, Call by Value vs. Call by Reference
